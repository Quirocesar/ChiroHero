...
const FIRST_NAMES = [
  'María', 'Carlos', 'Ana', 'Pedro', 'Laura', 'Miguel', 'Elena', 'David',
  'Sofía', 'Javier', 'Carmen', 'Antonio', 'Isabel', 'Roberto', 'Lucía',
  'Fernando', 'Rosa', 'Pablo', 'Marta', 'Andrés', 'Diana', 'Raúl',
  'Patricia', 'Diego', 'Valentina', 'Héctor', 'Claudia', 'Sergio',
  'Natalia', 'Óscar', 'Alejandra', 'Manuel', 'Camila', 'Ricardo',
  'Gloria', 'Felipe', 'Daniela', 'Jorge', 'Teresa', 'Enrique',
  'Emilio', 'Gabriela', 'Víctor', 'Lorena', 'Francisco', 'Adriana',
  'Eduardo', 'Verónica', 'Gabriel', 'Silvia', 'Alberto', 'Sandra',
  'Roberto', 'Monica', 'Gustavo', 'Andrea', 'Luis', 'Jessica',
  'Juan', 'Mariana', 'Alejandro', 'Cristina', 'Alberto', 'Daniela',
  'Martín', 'Lorena', 'Tomás', 'Valeria', 'Santiago', 'Natalia',
  'Bruno', 'Ivana', 'Matías', 'Florencia', 'Joaquín', 'Bárbara',
];

const LAST_NAMES = [
  'García', 'Martínez', 'López', 'González', 'Rodríguez', 'Hernández',
  'Pérez', 'Sánchez', 'Ramírez', 'Torres', 'Flores', 'Rivera',
  'Gómez', 'Díaz', 'Cruz', 'Morales', 'Reyes', 'Ruiz', 'Ortiz',
  'Gutiérrez', 'Navarro', 'Romero', 'Vargas', 'Castillo', 'Jiménez',
  'Molina', 'Suárez', 'Castro', 'Rojas', 'Delgado', 'Aguilar',
  'Serrano', 'Ramos', 'Vega', 'Campos', 'Herrera', 'Arias',
  'Medina', 'Guzmán', 'Reyes', 'Cortés', 'Sandoval', 'Estrada',
  'Blanco', 'Reyes', 'Luna', 'Santos', 'Mejía', 'Peralta',
  'Núñez', 'Escobar', 'Ochoa', 'Paredes', 'Lara', 'Salazar',
];

const OCCUPATIONS = [
  'Oficinista', 'Profesor/a', 'Conductor/a', 'Deportista', 'Ama de casa',
  'Albañil', 'Chef', 'Programador/a', 'Enfermero/a', 'Mecánico/a',
  'Vendedor/a', 'Agricultor/a', 'Músico/a', 'Peluquero/a', 'Pintor/a',
  'Carpintero/a', 'Abogado/a', 'Electricista', 'Bailarín/a', 'Cartero/a',
];
...
const TREATABLE_CONDITIONS = [
  {
    ...
    objective: 'Espasmo muscular en paravertebrales L4-L5. ROM limitado en flexión. Sin déficit neurológico.',
  ...
  },
  {
    ...
    subjective: 'Rigidez y dolor en el cuello, especialmente al girar la cabeza a la derecha. Usa ordenador 8h/día.',
    objective: 'Contractura del trapecio superior derecho. Restricción C5-C6 en rotación. Reflejos normales.',
  ...
  },
  {
    ...
    subjective: 'Dolor entre los omóplatos al respirar profundo. Empeoró tras cargar cajas pesadas.',
  ...
  },
  {
    id: 'sciatic_mild',
    name: 'Ciática leve',
    subjective: 'Dolor que baja por la pierna izquierda hasta la rodilla. No hay debilidad ni adormecimiento.',
    objective: 'Lasègue positivo a 60°. Reflejos L4-S1 normales. Fuerza 5/5. Contractura piriforme izq.',
  ...
  },
  {
    ...
    subjective: 'Dolores de cabeza frecuentes que empiezan en la nuca y suben a la frente. Sin náuseas ni aura.',
  ...
  },
  {
    ...
    objective: 'Test de Gaenslen positivo dcha. EIPS asimétrica. Piriforme contracturado bilateral.',
  ...
  },
  {
    ...
    subjective: 'Dolor difuso en toda la espalda. Trabaja muchas horas de pie. Peor al final del día.',
    objective: 'Hipercifosis torácica. Hombros anteriorizados. Contracturas múltiples. Sin hallazgos neurológicos.',
  ...
  },
  {
    ...
    subjective: 'Se despertó con el cuello trabado, no puede girar a la izquierda. Dolor intenso 7/10.',
    objective: 'Espasmo severo ECOM izquierdo. Cabeza inclinada a la izq. ROM cervical muy limitado.',
  ...
  },
  {
    ...
    subjective: 'Dolor agudo al lado derecho del pecho al respirar. Empezó después de estornudar fuerte.',
    objective: 'Fijación costovertebral derecha T3-T4. Dolor a la palpación intercostal. Respiración superficial.',
  ...
  },
  {
    ...
    objective: 'Contractura paravertebral L3-L4 bilateral. Dolor a la flexión. Sin signos neurológicos.',
  ...
  },
  {
    ...
    objective: 'Curva en "C" toracolumbar leve. Escápula derecha prominente. Test de Adams positivo leve.',
  ...
  // New treatable conditions
  {
    ...
    subjective: 'Adormecimiento y hormigueo en los dedos de la mano, especialmente de noche. Trabaja con ratón 8h/día.',
    objective: 'Signo de Phalen positivo bilateral. Reflejo aquíleo conservado. Fuerza flexores dedos 4/5.',
  ...
  },
  {
    ...
    subjective: 'Dolor y chasquidos al abrir la boca. No puede comer alimentos duros. Stress acumulado.',
    objective: 'Limitación apertura oral a 35mm. Desviación mandibular a la derecha. Dolor a la palpación ATM.',
  ...
  },
  {
    ...
    subjective: 'Dolor en el hombro al levantar el brazo. No puede peinarse. Empeoró tras pintar techos.',
  ...
  },
  {
    ...
    subjective: 'Dolor agudo en el talón al levantarse de la cama. Mejora al caminar pero duele al estar de pie.',
  ...
  },
  {
    ...
    subjective: 'Dolor e hinchazón en tobillo derecho tras torcedura hace 3 días. Camina con cojera.',
    objective: 'Edema lateral tobillo. Dolor a la palpación ligamento peroneo-astragalino anterior.',
  ...
  },
  {
    ...
    subjective: 'Dolor en el codo derecho al agarrar objetos. Empeoró tras jugar pádel el fin de semana.',
    objective: 'Dolor a la palpación epicóndilo lateral. Test de Cozen positivo. Fuerza puño reducida.',
  ...
  },
  {
    ...
    subjective: 'Dolor profundo en el glúteo que baja por la parte posterior del muslo. Peor al sentarse.',
  ...
  },
  {
    ...
    objective: 'Hipercifosis torácica >50°. Hombros anteriorizados. Contractura extensores dorsales.',
  ...
  },
  {
    ...
    objective: 'Contractura cervical severa. ROM muy limitado en todos los vectores. Reflejos normales.',
  ...
  },
  {
    ...
    subjective: 'Dolor anterior de rodilla al bajar escaleras. Cracking constante. Corre 10km diarios.',
  ...
  },
  {
    ...
    subjective: 'Adormecimiento en brazo y mano al levantar objetos. Fatiga al trabajar con brazos elevados.',
    objective: 'Test de Adson positivo izq. Debilidad intrínseca mano. Pulsos distales conservados.',
  ...
  // === NEW EDUCATIONAL CASES ===
  {
    ...
    subjective: 'Dolor de cuello y hombros tras trabajar desde casa con portátil sin escritorio adecuado.',
  ...
  },
  {
    ...
    subjective: 'Dolor crónico en la base del cuello. Usa el teléfono móvil más de 4 horas diarias.',
    objective: 'Inversión de lordosis cervical. Puntos gatillo en suboccipitales. Dolor a la extensión.',
  ...
  },
  {
    ...
    subjective: 'Dolor en la parte baja de la espalda al estar mucho tiempo sentado. Un glúteo duerme.',
  ...
  },
  {
    ...
    subjective: 'Dolores de cabeza frecuentes, especialmente por las tardes. Mucho tiempo frente al ordenador.',
  ...
  },
  {
    ...
    subjective: 'Dolor en el hombro al levantar el brazo. No puedeReach objetos altos. Empeora por la noche.',
    objective: 'Debilidad abducción hombro. Signo de Jobe positivo. Dolor a la palpación supraespinoso.',
  ...
  },
  {
    ...
    objective: 'Dolor en la cara externa del codo al extender la muñeca. Dolor a la palpación del epicóndilo.',
  ...
  },
  {
    ...
    subjective: 'Dolor en el codo al hacer swing de golf. Dolor aladar objetos con la palma hacia arriba.',
  ...
  },
  {
    ...
    subjective: 'Ardor y hormigueo en el muslo externo. No tolera ropa ajustada. Trabaja de pie 8h.',
  ...
  },
  {
    ...
    subjective: 'Hormigueo y dolor en el pie que mejora al caminar. Sensación de quemazón en el talón.',
  ...
  },
  {
    ...
    subjective: 'Dolor en la cara externa de la rodilla al correr. Crujido audible. No puede correr.',
  ...
  },
  {
    ...
    objective: 'Dolor a la palpación tendón rotuliano. Test de Stoltz negativo. Fuerza cuadriceps 4/5.',
  ...
  },
  {
    ...
    subjective: 'Rigidez y dolor en el talón por las mañanas. Empeora al correr. Usa calzado plano.',
    objective: 'Engrosamiento palpable tendón aquíleo. Dolor a la palpación 2-6cm proximal a inserción.',
  ...
  },
  {
    ...
    subjective: 'Cansancio constante en la espalda. Necesita recostarse frecuentemente. Trabaja sentada.',
    objective: 'Postura cifótica. Debilidad músculos extensores dorsales. Sin hallazgos neurológicos.',
  ...
  },
  {
    ...
    subjective: 'Dolor de hombros y cuello acumulado. Ha tenido mucho estrés laboral últimos meses.',
    objective: 'Contractura bilateral trapecios. Puntos gatillo activos. Migraña tensional asociada.',
  ...
  },
  {
    ...
    subjective: 'Despierta con el cuello rígido y dolor de cabeza. Duerme boca abajo con almohada alta.',
    objective: 'Restricción en extensión cervical. Contractura suboccipital. Sin signos neurológicos.',
  ...
  },
  {
    ...
    subjective: 'Dolor de hombro que no mejora con reposo. Ha intentadol lev antar objetos por encima.',
  ...
  // === NEW CONTENT: 10 Additional Treatable Conditions ===
  {
    ...
    name: 'Síndrome del desfiladero torácico',
    subjective: 'Hormigueo y pesadez en el brazo derecho al levantar objetos por encima de la cabeza. Trabaja en almacén.',
    objective: 'Test de Adson positivo derecho. Test de Roos positivo. Pulsos distales conservados. Sin déficit motor.',
  ...
  },
  {
    ...
    subjective: 'Dolor punzante en el costado izquierdo al respirar profundo. Empezó tras un partido de tenis.',
    objective: 'Dolor a la palpación de articulación costocondral 5ª-6ª costilla izquierda. Expansión torácica asimétrica.',
  ...
  },
  {
    ...
    subjective: 'Dolor sordo entre los omóplatos que empeora por la tarde. Trabaja como costurera 10h/día.',
    objective: 'Cifosis torácica aumentada. Contractura bilateral de romboides y trapecio medio. Sin irradiación.',
  ...
  },
  {
    ...
    subjective: 'Dolor en la cadera derecha al levantarse de la silla y al subir al coche. Cojea tras caminar mucho.',
    objective: 'Limitación rotación interna cadera dcha 15°. Test de FABER positivo. Sin crepitaciones groseras.',
  ...
  },
  {
    ...
    subjective: 'Dolor en la zona lumbar alta que se irradia a la cresta ilíaca. A veces siente dolor en la ingle.',
    objective: 'Punto gatillo en unión toracolumbar T12-L1. Dolor a la palpación cresta ilíaca posterosuperior. Skin rolling positivo.',
  ...
  },
  {
    ...
    subjective: 'Se despertó con el cuello completamente bloqueado. No puede girar ni a derecha ni a izquierda. Dolor 9/10.',
    objective: 'Espasmo severo bilateral ECOM y escalenos. Cabeza en posición antálgica. ROM cervical <10° en todas direcciones.',
  ...
  },
  {
    ...
    subjective: 'Dolor en el codo que no mejora con tratamiento local. Ha probado férulas y fisioterapia sin éxito.',
    objective: 'Test de Spurling positivo C5-C6. Reproducción del dolor de codo con compresión cervical. Epicóndilo sensible.',
  ...
  },
  {
    ...
    subjective: 'Dolor quemante que sigue el trayecto de una costilla del lado derecho. Empeora con la tos y los estornudos.',
    objective: 'Dolor neuropático en dermatoma T7 derecho. Hiperalgesia en franja intercostal. Sin vesículas. Costilla T7 fijada.',
  ...
  },
  {
    ...
    subjective: 'Dolor profundo en la zona del sacro que empeora al estar mucho de pie. A veces baja por el muslo posterior.',
    objective: 'Test de Gaenslen positivo bilateral. Test de compresión sacroilíaca positivo. EIPS asimétrica marcada.',
  ...
  },
  {
    ...
    subjective: 'Dolores de cabeza diarios que empiezan en la nuca, suben por un lado y llegan al ojo. Náuseas leves. Sin aura.',
    objective: 'Restricción C0-C1 y C1-C2 bilateral. Suboccipitales hipertónicos con puntos gatillo activos. Test de flexión-rotación positivo.',
...
const REFERRAL_CONDITIONS = [
  {
    ...
    subjective: 'Dolor lumbar intenso con adormecimiento en zona perineal. Dificultad para orinar desde ayer.',
    objective: 'Anestesia en silla de montar. Reflejos aquíleos abolidos bilateral. Retención urinaria.',
  ...
  },
  {
    ...
    subjective: 'Torpeza en las manos, dificultad para abrochar botones. Sensación eléctrica al flexionar cuello.',
    objective: 'Signo de Lhermitte positivo. Hiperreflexia en MMII. Babinski positivo bilateral. Clonus.',
  ...
  },
  {
    ...
    subjective: 'Dolor de espalda que no mejora con reposo, peor por la noche. Ha perdido 8kg en 2 meses sin dieta.',
  ...
  },
  {
    ...
    subjective: 'Dolor de espalda constante con fiebre de 38.5°C. Tuvo una infección urinaria hace 2 semanas.',
    ...
    referralReason: 'Fiebre + dolor vertebral + antecedente infeccioso = posible infección vertebral.',
  ...
  },
  {
    ...
    subjective: 'Dolor lumbar pulsátil que se irradia al abdomen. Paciente de 68 años, fumador, hipertenso.',
  ...
  // New red flag conditions
  {
    ...
    subjective: 'Dolor, adormecimiento y debilidad en ambas piernas al caminar. Mejora al sentarse.',
    objective: 'Marcha neurológica alterada. Debilidad extensores dorsales pie bilateral. Reflejos hiperactivos.',
  ...
  },
  {
    ...
    subjective: 'Dolor lumbar crónico que ha empeorado. Siente que la espalda cede al estar de pie.',
    objective: 'Escalón palpable en línea media lumbar. Limitación lumbar severa. Signo de Stork positivo.',
    assessment: 'SOSPECHA DE ESPONDILOLISTESIS - DERIVAR',
    referralReason: 'Inestabilidad vertebral. Requiere imagen diagnóstica y posibles limitaciones de actividad.',
  ...
  },
  {
    ...
    referralReason: 'Patología articular degenerativa avanzada. Requiere tratamiento especializado.',
  ...
  },
  {
    ...
    objective: 'Puntos gatillo positivos múltiples (>11/18). Sensibilidad generalizada. Sin hallazgos neurológicos.',
    assessment: 'SOSPECHA DE FIBROMIALGIA - DERIVAR A REUMATOLOGÍA',
    referralReason: 'Síndrome de dolor crónico generalizado. Requiere diagnóstico y manejo multidisciplinar.',
    specialist: 'Reumatología',
  ...
  },
  {
    ...
    subjective: 'Dolor lumbar inflamatorio que mejora con ejercicio. Rigidez matutina de más de 1 hora.',
    objective: 'Limitación expansión torácica <2.5cm. Test de Schober positivo. Sacroilitis bilateral.',
    assessment: 'SOSPECHA DE ESPONDILITIS ANQUILOSANTE - DERIVAR URGENTE',
    referralReason: 'Enfermedad inflamatoria crónica de columna. Requiere inicio temprano de tratamiento.',
  ...
  // === NEW CONTENT: 5 Additional Referral Conditions ===
  {
    ...
    subjective: 'Dolor de cabeza intenso con fiebre alta y no tolera la luz. Rigidez en el cuello desde anoche.',
    objective: 'Fiebre 39.2°C. Rigidez nucal severa. Signo de Kernig positivo. Fotofobia marcada. Confusión leve.',
    assessment: 'SOSPECHA DE MENINGITIS - DERIVAR A URGENCIAS INMEDIATAMENTE',
    referralReason: 'Triada clásica: fiebre + rigidez nucal + fotofobia. Posible infección meníngea. NO MANIPULAR.',
  ...
  },
  {
    ...
    subjective: 'Mareo intenso repentino con visión doble y dificultad para tragar. Dolor cervical tras movimiento brusco.',
    objective: 'Nistagmo espontáneo. Diplopía. Disfagia. Disartria leve. Signo de Horner ipsilateral.',
    assessment: 'SOSPECHA DE DISECCIÓN ARTERIAL VERTEBRAL - EMERGENCIA VASCULAR - NO MANIPULAR',
    referralReason: 'Síntomas vasculares cervicales agudos. Riesgo de ACV. Requiere imagen vascular urgente.',
  ...
  },
  {
    ...
    subjective: 'Dolor de espalda constante que empeora por la noche y no cede con reposo. Fiebre intermitente. Ha perdido 4kg en un mes.',
    objective: 'Fiebre 37.8°C. Dolor severo a la percusión L2-L3. Espasmo protector intenso. Sudoración nocturna referida.',
    assessment: 'SOSPECHA DE ESPONDILODISCITIS - DERIVAR PARA ESTUDIO URGENTE',
    referralReason: 'Fiebre + dolor nocturno que no cede + pérdida de peso = alta sospecha de infección discal.',
  ...
  },
  {
    ...
    subjective: 'Dolor lumbar irradiado a pierna izquierda. No puede levantar el pie. Ha notado problemas para controlar la orina.',
    objective: 'Pie caído izquierdo (fuerza 1/5 dorsiflexión). Reflejo aquíleo abolido izq. Incontinencia urinaria referida. Lasègue positivo a 20°.',
    assessment: 'HERNIA DISCAL CON DÉFICIT NEUROLÓGICO SEVERO - DERIVAR URGENTE A NEUROCIRUGÍA',
    referralReason: 'Pie caído + incontinencia urinaria = compresión radicular severa. Posible cirugía urgente.',
    specialist: 'Neurocirugía - URGENCIAS',
  ...
  },
  {
    ...
    subjective: 'Dolor súbito en la espalda media sin haber tenido ningún golpe. Tiene osteoporosis severa diagnosticada. Nota deformidad.',
    objective: 'Cifosis angular aguda T8. Dolor exquisito a la palpación T8. Deformidad visible. Sin déficit neurológico actual.',
    assessment: 'FRACTURA VERTEBRAL PATOLÓGICA POR OSTEOPOROSIS - NO MANIPULAR - DERIVAR',
    referralReason: 'Osteoporosis severa + dolor súbito sin trauma + deformidad = fractura patológica. Requiere imagen urgente.',
...
const PREMIUM_PATIENTS = [
  {
    ...
    subjective: 'Tensión muscular por entrenamiento intenso. Competición mañana. Necesita estar al 100%.',
    objective: 'Múltiples restricciones torácicas T3-T8. Contractura bilateral de psoas. Alto tono muscular.',
    zones: ['cervical', 'thoracic', 'lumbar'],
    difficulty: 4,
    payMultiplier: 5,
    xpReward: 100,
  ...
  },
  {
    ...
    subjective: 'Dolor en espalda baja y cadera tras patadas altas repetitivas. Torneo este fin de semana.',
  ...
  },
  {
    ...
    objective: 'Restricción cervical múltiple C2-C6. Hipertonía cervical bilateral. Restricción T1-T3.',
    zones: ['cervical', 'thoracic'],
    difficulty: 5,
    payMultiplier: 8,
    xpReward: 150,
  ...
  },
  {
    ...
    objective: 'Múltiples restricciones pélvicas. Contractura cuádriceps bilateral. Disfunción sacroilíaca.',
    zones: ['lumbar', 'gluteal', 'thoracic'],
    difficulty: 4,
    payMultiplier: 6,
    xpReward: 110,
...
const CHILD_PATIENTS = [
  {
    ...
    age: 12,
    subjective: 'Los padres notan que tiene un hombro más alto que el otro. El niño se cansa rápido.',
    objective: 'Curva torácica leve. Test de Adams positivo. Escápula derecha prominente en bipedestación.',
    zones: ['thoracic', 'cervical'],
    difficulty: 3,
    xpReward: 35,
    minSkillLevel: 2,
  },
  {
    ...
    objective: 'Cifosis torácica aumentada. Cabeza anteriorizada. Hombros redondos. Sin signos neurológicos.',
    zones: ['cervical', 'thoracic'],
    difficulty: 2,
    xpReward: 25,
    minSkillLevel: 1,
  ...
  chapters: [
    {
      ...
      redFlags: ['Anestesia en silla de montar', 'Retención o incontinencia urinaria', 'Debilidad bilateral MMII'],
      action: 'DERIVAR A URGENCIAS INMEDIATAMENTE',
    },
    {
      title: 'Fracturas Vertebrales',
      description: 'Pérdida de integridad ósea vertebral.',
      redFlags: ['Traumatismo reciente', 'Dolor exquisito a la palpación', 'Osteoporosis conocida', 'Uso prolongado de corticoides'],
      action: 'NO MANIPULAR - DERIVAR A TRAUMATOLOGÍA',
    },
    {
      title: 'Mielopatía',
      description: 'Compresión de la médula espinal.',
      redFlags: ['Signo de Lhermitte', 'Babinski positivo', 'Hiperreflexia', 'Torpeza en manos', 'Alteración de la marcha'],
    ...
    },
    {
      ...
      redFlags: ['Dolor nocturno que no cede', 'Pérdida de peso inexplicable', 'Antecedente de cáncer', 'Edad >50 con dolor nuevo'],
      action: 'DERIVAR PARA ESTUDIO ONCOLÓGICO',
    },
    {
      title: 'Infecciones Vertebrales',
      description: 'Espondilodiscitis, absceso epidural.',
      redFlags: ['Fiebre', 'Infección reciente', 'Inmunosupresión', 'Uso de drogas IV', 'Sudoración nocturna'],
      action: 'DERIVAR A MEDICINA INTERNA URGENTE',
    },
    {
      title: 'Patología Vascular',
      description: 'Aneurisma aórtico, disección arterial.',
      redFlags: ['Masa pulsátil abdominal', 'Dolor no mecánico', 'HTA no controlada', 'Dolor torácico irradiado'],
...
function pickSocialClass(reputation = 0, consultPrice = 100, day = 1) {
  ...
  const richWeight = Math.min(
    40,
    8 + Math.floor(rep / 40) + priceOverBase * 2 + prestigeGrowth
  );
...
function generatePatient(skillLevel = 1, day = 1, reputation = 0, consultPrice = 100) {
  ...
  if (isChild && skillLevel >= 2) {
    age = randomFrom(CHILD_PATIENTS).age;
  } else if (isElderly) {
  ...
  if (isInfluencer) {
    influencerData = randomFrom(INFLUENCERS);
  }

  let condition;
  if (isReferralCase) {
    condition = randomFrom(REFERRAL_CONDITIONS);
  } else if (isChild && skillLevel >= 2) {
    const availableChild = CHILD_PATIENTS.filter(c => c.minSkillLevel <= skillLevel);
    condition = randomFrom(availableChild.length > 0 ? availableChild : CHILD_PATIENTS);
  } else if (isElderly) {
    const availableElderly = ELDERLY_PATIENTS.filter(c => c.minSkillLevel <= skillLevel);
    condition = randomFrom(availableElderly.length > 0 ? availableElderly : ELDERLY_PATIENTS);
  } else {
    const available = TREATABLE_CONDITIONS.filter(c => c.difficulty <= skillLevel + 1);
    condition = randomFrom(available.length > 0 ? available : TREATABLE_CONDITIONS.slice(0, 3));
  }
  ...
  const requiresDiscountNegotiation =
    !isInfluencer &&
    Math.random() < socialProfile.discountRequestChance &&
    !isReferralCase;
...
export function generatePremiumPatient(reputation) {
  const available = PREMIUM_PATIENTS.filter(p => reputation >= p.minReputation);
...
export { generatePatient, generatePixelAvatar, TREATABLE_CONDITIONS, REFERRAL_CONDITIONS, PREMIUM_PATIENTS, PATHOLOGY_BOOK, CHILD_PATIENTS, ELDERLY_PATIENTS };
